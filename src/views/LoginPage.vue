...
// Reactive user state for login
const user = reactive<User>({
  login: '',
  password: ''
})

// Reactive register state for registration form
...
// Reactive variables for toggling forms
...
const handleRegister = () => {
  ...
  console.log('Datos de registro:', register) // Imprime el objeto completo
  if (register.password === register.passwordConfirm) {
    console.log('Registrando usuario con los siguientes datos:')
    console.log(`Email: ${register.email}`)
    console.log(`Contraseña: ${register.password}`)
  } else {
